namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAvgRealtyPriceProccessMethodsWrapper

	/// <exclude/>
	public class UsrCalcAvgRealtyPriceProccessMethodsWrapper : ProcessModel
	{

		public UsrCalcAvgRealtyPriceProccessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var priceColumn = esq.AddColumn("UsrUSDPrice");  // SELECT UsrPrice as UsrPrice, UsrArea as UsrArea FROM UsrRealty WHERE ...
